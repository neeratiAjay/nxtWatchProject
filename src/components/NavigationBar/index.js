        ...
        <NavigationContainer darkMode={darkMode}>
          <DivItem>
            <NavContainer darkMode={darkMode}>
              <LinkItem
                to="/"
                color={activeOptionId === 'home' ? activeTextColor : nonActive}
              >
                <NavListItem
              ...
              >
                <NavListItem
                  ...
                  key="trending"
                  darkMode={darkMode}
                  bgColor={activeOptionId === 'trending' ? activeTabBg : 'none'}
                >
                  <FaFire
                    size="16"
                    color={
              ...
              >
                ...
                >
                  <SiYoutubegaming
                    size="16"
                    color={activeOptionId === 'gaming' ? '#ff0000' : ' #606060'}
                  />
              ...
              <LinkItem
                to="/saved"
                color={
                  activeOptionId === 'savedVideos' ? activeTextColor : nonActive
                }
              >
                <NavListItem
                ...
                >
                  <MdPlaylistAdd
                    size="18"
                    color={
                      activeOptionId === 'savedVideos' ? '#ff0000' : ' #606060'
                    }
                  />
